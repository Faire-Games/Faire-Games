...
android {
    namespace = "dev.daybrite.games"
    compileSdk = 35
    defaultConfig {
        applicationId = dayApp.getProperty("applicationId") ?: "dev.daybrite.games"
        minSdk = 24
        targetSdk = 35
        ...
        manifestPlaceholders["dayTitle"] = dayApp.getProperty("title") ?: "Day Games"
